   ...
   <div>
        ...
        <div id="nav-box">
            <ul class="nav-container">
                <router-link tag="li" to="/oldline"><a href="">
...
export default {
    ...
    data(){
       return {
          images:[
              'https://img0.kfzimg.com/operation/4a/d8/4ad8e82aa849f5fadd3ffd446ff93c35.png',
              'https://img0.kfzimg.com/operation/46/d9/46d9f280fdc09917df01a6bf3cfcaa86.png',
